...
- A slow browser pushes people to Chrome. YuzuFox tunes the JIT, compositor,
  caches, GPU pipeline, and network stack aggressively — trading idle
  RAM/CPU/GPU for lower latency. Every perf pref is verified against
